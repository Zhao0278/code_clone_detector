...
class CodeWindow():
    ...
    def to_info_dict(self):
        ...
        if self.window_type == "hunk":
            ...
            info_dict["code_window"] = self.code_window
            info_dict["inline_labels"] = self.inline_labels
            info_dict["inter_labels"] = self.inter_labels
            info_dict["after_edit"] = self.after_edit
            info_dict["type"] = self.edit_type # "replace", "insert", "delete"
            info_dict["file_path"] = self.file_path
            info_dict["edit_start_line_idx"] = self.edit_start_line_idx
        else:
            info_dict["code_window"] = self.code_window
            info_dict["sliding_window_type"] = self.sliding_window_type
            info_dict["inline_labels"] = self.inline_labels
            info_dict["inter_labels"] = self.inter_labels
            info_dict["overlap_hunk_ids"] = self.overlap_hunk_ids
            info_dict["file_path"] = self.file_path
            # info_dict["to_insert"] = self.to_insert
            info_dict["edit_start_line_idx"] = self.edit_start_line_idx
        return info_dict
